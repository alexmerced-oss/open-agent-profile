...
OAP 1.0 maintenance release 1.0.2 accepts `oap: "1.0"`. Unsupported document minors and majors fail closed. A new optional standard field requires OAP 1.1 and a separately published schema. An incompatible field or behavior requires OAP 2.0.
